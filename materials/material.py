...
class Crystal(Material):
    ...
    def __eq__(self, other):
        ...
        parameters like thetaDebye and the elastic parameters are ignored.
    ...
    def show_unitcell(self, fig=None, subplot=111, scale=0.6, complexity=11, linewidth=1.5, mode='matplotlib'):
        """
